    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="" name="editJobForm" method="post" id="editJobForm">
                            ...
                            <div class="row">
                                <div class="md-4 col-md-6">
                                    <div class="form-check">
                                        ...
                                        <label for="form-check-label" for="isFeatured">Featured</label>
                                    </div>
                                </div>
                                ...
                                <div class="md-4 col-md-6">
                                    <div class="form-check-inline">
                                        ...
                                        <label for="form-check-label" for="status">Active</label>
                                    </div>
                                    <div class="form-check-inline">
                                        <input {{ ($job->status == 0) ? 'checked' : ''}} class="form-check-input" type="radio" value="0" id="status-block" name="status">
                                        <label for="form-check-label" for="status">Block</label>
                                    </div>
                                </div>
                            </div>
