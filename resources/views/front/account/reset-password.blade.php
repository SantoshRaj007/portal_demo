        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-5">
                <div class="card shadow border-0 p-5">
                    ...
                    <form action="{{ route('account.processResetPassword') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" value="" name="confirm_password" id="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror" placeholder="Enter New password">
                ...
                <div class="mt-4 text-center">
                    <p>Do you have an account? <a  href="{{ route('account.login')}}">Click here to Login</a></p>
                </div>
            </div>
        </div>
